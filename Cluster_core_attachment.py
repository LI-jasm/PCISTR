...
dataset = "collins"
p = '../data' + '/' + dataset + '/'
protein_out_file = p + "protein.temp"  #for each protein a index
cliques_file = p + "cliques"
ppi_pair_file = p + "ppi.pair"
ppi_matrix_file = p + "ppi.matrix"
...
if __name__ == "__main__":
    ...
    os.system(
        "ConvertPPI.exe " + str2 + " " + protein_out_file + " " + ppi_pair_file + " " + ppi_matrix_file)
    os.system(
    ...
    final_file = open('../data/result/final_' + dataset + '_attr_output', "w")
